...
import ClientProgram.GUI.MainGameController;
import ClientProgram.GUI.PaneNavigator;
import ClientProgram.GUI.PopUpMessage;
...
public class MessageHandler {
    ...
    void handle(String in){
        ...
        switch (identifier) {
            case "ECHO":
                if (message == null) {
                    System.out.println("ClientProgram.Client pinged by server");
